...
# ╔═╡ 1af6714a-37d9-4a9c-87db-71138a43a504
using DelimitedFiles, Plots, PlutoUI,  NoiseRobustDifferentiation

# ╔═╡ 32c540a2-0199-4d32-96c0-2392d2bc92b8
plotly()

# ╔═╡ af528515-a943-402d-99d1-f5a28df74e13
TableOfContents()

# ╔═╡ efebb9a6-036a-49ff-b667-29f5c7251a66
md"""# Process raw tunneling *I(V)* spectra
using [noise robust differentiation](https://adrianhill.de/NoiseRobustDifferentiation.jl/) \
[Rick Chartrand](https://onlinelibrary.wiley.com/doi/10.5402/2011/164564)
"""

# ╔═╡ c3e5fc30-0c88-4523-b4e2-a57ada418aa2
md"""## Import experimental data
*e.g.* "...\Dokumenty\data\SPECS\Pb\24-11-13\2400mK\olovo-2.44001-Export001.dat"
"""

# ╔═╡ 20f5caf4-7e09-4767-8c73-40fa0b44f963
@bind file FilePicker()

# ╔═╡ bf1b2d31-4ce5-42fc-8da9-7a639ce4bf56
begin
	controller = @bind controller Select([1 => "Nanonis", 2 => "WSxM", 3 => "raw data"])
	md"Select file type: $(controller)"
end

# ╔═╡ 226389eb-3cc2-425a-a9ef-996c5af50825
begin
	if controller == 2
...
# ╔═╡ 45ce156a-4e8a-4325-91b9-c9599f2f556d
md"""Select among:
1. Nanonis .dat file
2. WSxM .cur file
...
# ╔═╡ ab55179d-f12c-411e-8f65-53797de8ffca
#read data from file
begin
	tmp=tempname()
	open(tmp, "w") do f
	...
	function read_data_after_marker(file, marker)
	    open(file) do io
	        ...
	        return readdlm(io, ' ', header = false)
	    end
	end
	# Define the marker you're looking for
...
# ╔═╡ 7dffcf6e-7d69-4278-9377-9d91ff233da1
begin
...
manifest_format = "2.0"
project_hash = "61c06689342d4fb6649c085271978cd6d5e82b7f"
