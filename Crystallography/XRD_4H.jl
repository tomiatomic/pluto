...
using DelimitedFiles, Plots, PlotlyBase, PlotlyBase, PlotlyKaleido, CurveFit, PlutoUI, LaTeXStrings
...
begin
	dir = @bind dir Select([raw"C:\Users\PC" => "Angelinum", raw"C:\Users\tomas" => "Spectre"])
...
begin 
	plot(powt.-0.2, log.(powi), label="XRD",
		ylabel = "log[I(XRD)]", 
		xlabel = L"2\Theta [\degree]",
		legend = :top, 
		xlimits=(xd,xu),
		ylims = (0, :auto))
	plot!(twinx(), hdt, hdi, lw=2, 
		color=:magenta, alpha=:0.5, 
		label= L"4H_{dII}~Kadijk",
		legend = :topright,
		ylabel = "I(Brown et al.)",
		ylimits=(-1,50), 
		xlimits=(xd,xu))
end
...
begin 
	plot(riett, rieti, lw=2, color=:blue,
		#title=L"4H_a",
		label="Vesta",
		ylabel = "a.u.", 
		xlabel = L"2\Theta [\degree]",
...
begin 
	plot(riett, rieti, lw=2, color=:red,
		title=L"4H_a",
		label=L"4H_a~Rietveld",
		ylabel = "Rietveld", 
		xlabel = L"2\Theta [\degree]",
		legend = :top, 
		xlimits=(xd,xu),
		ylims = (0, :auto))
	plot!(twinx(), hat, hai, lw=2, 
...
# ╔═╡ a331d46b-5e69-4ca8-b65d-938aee8e30fb
md"## Measurements by Gao & Marie-Aude"

# ╔═╡ 67f6913a-4754-44d5-bb15-86fce4c50104
md"""
![Gao](https://raw.githubusercontent.com/tomiatomic/pics/refs/heads/main/Raman.png)
"""
